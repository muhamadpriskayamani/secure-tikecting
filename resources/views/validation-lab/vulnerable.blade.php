                        ...
                        <form action="{{ route('validation-lab.vulnerable.submit') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" required
                                    minlength="2" maxlength="100" placeholder="Masukkan nama">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="age" id="age" class="form-control" required
                                    min="17" max="100" placeholder="Masukkan umur">
                                <small class="text-muted">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="message" id="message" class="form-control" required minlength="10" maxlength="1000" rows="3"
                ...
                <div class="card border-warning mt-3">
                    ...
                    <div class="card-body small">
                        <ol class="mb-0">
                            ...
                            <li>Hapus atribut: <code>required</code>, <code>min</code>, <code>max</code>,
                            ...
                            <div class="border rounded p-3 mb-3 bg-light">
                                ...
                                @php
                                    ...
                                    if (empty($data['age'])) {
                                        ...
                                        $issues[] = 'Umur bukan angka';
                                    } elseif ($data['age'] < 17 || $data['age'] > 100) {
                                        $issues[] = 'Umur di luar range';
                                    }
                                    if (!in_array($data['priority'] ?? '', ['low', 'medium', 'high'])) {
                                        $issues[] = 'Priority invalid';
                                    }
                                    if (empty($data['message'])) {
                                        $issues[] = 'Pesan kosong';
                                    } elseif (strlen($data['message']) < 10) {
                                        $issues[] = 'Pesan terlalu pendek';
                                    }
                                @endphp
